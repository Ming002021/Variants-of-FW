...
# module Myutility_FiniteBound            #
# 	function Finite_LBUB (Not Used)       #
###########################################  
...
module Myutility_FiniteBound
    ...
    function Finite_LBUB(Instance)

        ############################################################################################################
        #Check if some elements of LB or UB are infinity                                                           #
		#If some elements of LB or UB are infinity,                                                                #
		#then we skip this problem and do not implement an algorithm on it                                         #
	    #After reading all problem data from the given mat file and then getting Instance,                         #
		#                                                                                                          #
		#                                                                                                          #
		#After reading all the problem data from the given mat file and then getting the instance,                 #
		#I have to check it through the Finite_LBUB function before I can use it as input to any other function    #
        ############################################################################################################
