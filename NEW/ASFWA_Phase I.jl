...
for j in 1:3
    ...
    for i in 51:83 #instance_Type_length
        ...
        output2_path="/Users/Mindy/Desktop/NEW/Text/ASFWA_Phase I/$(instance_Type)"                                
        cd(output2_path)
        ...
        open("$(mat_file)_$(epsilName).txt", "w") do file  
            ...
            write(file,"The  Away-Steps Frank-Wolfe Algorithm in Atom Version with Phase I is Starting:\n") 
            write(file, "\n")
