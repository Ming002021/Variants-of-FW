...
cd(output1_path) 
mat_file=readdir()[3]                                            #Select the mat file that will be used
...
output2_path="/Users/Mindy/Desktop/NEW_RT/Text/$(fun)_KKT/$(instance_Type)"   #Go to the output directory                             
cd(output2_path)
