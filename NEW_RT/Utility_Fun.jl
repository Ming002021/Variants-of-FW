...
module Myutility_AwayStep_Max
	...
	function AwayStep_GammaMax(x::Vector{Float64}, UB,LB,A,b, d::Vector{Float64})
...
module   Myutility_LineSearch
    ...
    function linesearchQP(x::Vector{Float64}, Q,c, T, d::Vector{Float64}, gamma_max::Float64)
...
module MyLP_module
	...
	function solveLP_Away_Atoms(x::Vector{Float64}, D, Q,c)
