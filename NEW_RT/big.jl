...
global instance_Type=instance_Type_vec[h]
global instance_Type_length=instance_Type_length_vec[h]
...
for j in 3:3
    ...
    for i in 1:instance_Type_length
        ...
        try 
             ...
             x_1= value.(x)  
             b = @benchmark PFW($x_1,$K,$epsil,$A,$Aeq,$b,$beq,$LB,$UB,$Q,$c,$T,$n) evals=10 samples=100 seconds = 10000;  
             min = minimum(b)
             ...
             open("$(mat_file)_$(epsilName).txt", "w") do file  
              ...
              output2_path="/Users/Mindy/Desktop/NEW_RT/Text/PFW_Phase I/"                                
              cd(output2_path)
 
              open("PFW_PhaseI.txt", "a+") do file  
